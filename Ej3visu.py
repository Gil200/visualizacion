...
with tab1:
    ...
    # Chart 6: Estimated number of people (proxy: minimum nights) by listing type
    fig6 = px.box(filtered_df, x="listing_type", y="minimum_nights", title="Estimated Number of People by Listing Type (Proxy: Minimum Nights)")
